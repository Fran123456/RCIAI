...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2018 a las 06:14:16
...
('COMPRA-h1nNUXwKPR-8364331-3939', 'fisica', ' PC , Perifericos', 'no tiene detalle', 20, 0, 'dell', '12345-A', '2018-11-08', '2018-11-08', '1 año', '1000.00', '', 1);
...
--
ALTER TABLE `unidad`
  MODIFY `id_unidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
