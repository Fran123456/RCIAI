...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-01-2019 a las 20:10:06
...
('monitor_med04', 'LED', 'HP', '', 'MONITOR', '', 'En uso', '2018-12-07', 1, '2019-01-18', 10, 'COMPRA-l9KBfLuU6M-8651805-5221', 'PC004USAM', NULL, '2018-12-07 19:41:14'),
...
('monitor5', 'MONITOR', 'Dell', '', 'MONITOR', '', 'Desechado', '2018-12-07', 10, NULL, 1, 'COMPRA-l9KBfLuU6M-8651805-5221', NULL, 'PC004USAM', '2018-12-07 19:48:47'),
...
(17, 'token--3ZRNLlv7eQ285552-5103LchkS', '2019-01-18', '2019-01-18', 'PC004USAM', 10, 1, '1', '1', 1, 10, '1', '1', '1', '1', 'HARDWARE-EXTERNO', 'Sustitucion-bodega', 'monitor_med04', NULL);
...
--
ALTER TABLE `adaptador_red`
  MODIFY `id_red` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `movimiento`
  MODIFY `id_cambio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
