...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-01-2019 a las 04:00:06
...
(33, 'HW-PC1', '1', 'Ethernet', '12233.00000.1', 'no tiene subred', 'Gateway IP predeterminado', 'no existe servidor', 'DNS', 'DJCD', 'MAC', NULL),
(34, 'LAP00344USAM', NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, '1');
...
(33, 'HW-PC1', NULL, NULL, NULL, NULL, 'no tiene', 'no tiene adaptador de ram', 'dafd', 'alv no tien monitor', '4k', 'no hay generacion >:v'),
(34, 'LAP00344USAM', '', NULL, '1', '', NULL, NULL, NULL, NULL, NULL, NULL);
...
(33, 'HW-PC1', 'intel disk celeron', '1 TB', NULL, 'si', 'nel', 'stfp', '400', '200 GB', 'c:'),
(34, 'LAP00344USAM', '1', '', '1', '1', NULL, NULL, NULL, NULL, NULL);
...
(1, 'TAUD001USAM\r\n', 'GENIUS', 'X72696601762', 'PS/2', 'EQ4', 'teclado'),
...
('COMPRA-GtXxNrWwAp-8443841-3063', 'fisica', ' ', '1', 1, 0, '1', '', '2019-01-21', '2019-01-27', '', '0.00', '', 1),
('COMPRA-l9KBfLuU6M-8651805-5221', 'fisica', ' PC completa', 'equipo nuevo completo', 10, 3, 'office depot', '123456789', '2018-12-07', '2018-12-07', '1 año', '5000', 'equipo nuevo', 2),
('COMPRA-SdHWGjpZwe-8613129-1440', 'fisica', ' yyyy', '8', 1, 0, '1', '8', '2019-01-04', '2019-01-08', '8', '0.00', '', 1),
...
(5, 'COMPRA-l9KBfLuU6M-8651805-5221', 37, 5),
(6, 'COMPRA-9tYiRqUFWZ-9378724-6993', 2, 6),
(7, 'COMPRA-9tYiRqUFWZ-9378724-6993', 6, 2),
(8, 'COMPRA-l9KBfLuU6M-8651805-5221', 37, 5),
(9, 'COMPRA-l9KBfLuU6M-8651805-5221', 2, 5),
...
(33, 'HW-PC1', 'HW01', 'dell', 'windows 10', '32 bits', 'admin1', '5.01', '54252-11347765754-4', '4 GB', 'WORKGROUP', '5643-1', '222-222-222', 'sin organizacion', 'Español (México)', '(GMT -06:00) Hora estándar, América Central', '', '12', 'Desktop'),
(34, 'LAP00344USAM', '1', 'Intel', '1', '64 bits', NULL, NULL, 'admin', '4', 'Sin grupo', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL);
...
(40, 'LAP00344USAM', '4', 'LAP00344USAM', 'LAP00344USAM', 'LAP00344USAM', 'LAP00344USAM', 'LAP00344USAM', '2019-01-02', 4, NULL, 2, 'COMPRA-l9KBfLuU6M-8651805-5221', 'Academica', '55555');
...
('0001334354-5s', '', 'monitor dell chidito', '', 'MONITOR', '', 'En uso', '2019-01-14', 38, NULL, 37, NULL, 'HW-PC1', NULL, '2019-01-14 19:59:01'),
...
('3123', '3', '3', '3', 'WEBCAM', '3', 'En uso', '2018-12-07', 4, NULL, 37, 'COMPRA-l9KBfLuU6M-8651805-5221', 'LAB1-PC1', NULL, '2019-01-27 22:35:50'),
...
('33aaaaaaaa', '', '', '', 'MOUSE', '', 'En uso', '2019-01-14', 38, NULL, 37, NULL, 'HW-PC1', NULL, '2019-01-14 19:59:01'),
...
('55555', '', '4', NULL, 'LAPTOP', NULL, 'En uso', '2019-01-02', 4, NULL, 2, 'COMPRA-l9KBfLuU6M-8651805-5221', 'LAP00344USAM', NULL, '2019-01-27 23:02:49'),
...
('829106961516652333xxxxx', '', '', '', 'TECLADO', '', 'En uso', '2019-01-14', 38, NULL, 37, NULL, 'HW-PC1', NULL, '2019-01-14 19:59:01'),
...
('asdasdasdsa321214323432', '', '', '', 'CPU', '', 'En uso', '2019-01-14', 38, NULL, 37, NULL, 'HW-PC1', NULL, '2019-01-14 19:59:01'),
...
('Monitor001', 'LED', 'HP', '', 'MONITOR', '', 'En uso', '2018-12-07', 1, '2019-01-03', 6, 'COMPRA-l9KBfLuU6M-8651805-5221', 'PC001USAM', NULL, '2018-12-07 17:35:52'),
...
(7, 'HW-PC1', 'HW-PC1', 'HW-PC1', 'HW-PC1', 'HW-PC1', 'HW-PC1', '2019-01-14', 38, NULL, 37, NULL, 'lab-HW', NULL),
(8, 'WEBCAM00003LAB1', NULL, NULL, NULL, NULL, NULL, '2018-12-07', 4, NULL, 37, '3123', '01', 'COMPRA-l9KBfLuU6M-8651805-5221');
...
(16, 'token--N7fy546g9k438318-9279mJbQi', '2019-01-23', '2019-01-03', 'PC001USAM', 6, 1, 'e', 'e', 1, 6, 'e', 'e', 'Dembele kagawa', 'Kiko paladino', 'HARDWARE-EXTERNO', 'Sustitucion-bodega', 'Monitor001', NULL);
...
(33, 'HW-PC1', 'intel core i5', '5.1', 'Intel', 'no tiene etiqueta', '4-54331-11-1', 'no tiene version', 'no tiene numero de serie la bios', '2019-01-14', 'ASUS', '544-asus-4k', 'no tiene version la placa', 'KINSTONG', '', '', '', '', '', ''),
(34, 'LAP00344USAM', '1', '1', 'Intel', NULL, NULL, NULL, NULL, NULL, NULL, 'Sin grupo', NULL, 'Sin grupo', NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, NULL, 'LAB1-PC1', 'Microsoft Word 2016', 'Microsoft', 'word', '2016', ' Word.exe'),
(2, NULL, 'LAB1-PC1', 'Microsoft Excel 2016', 'Microsoft', 'Excel', '2016', 'Excel.exe');
...
(5, 'enrique001', 'Karla', 'Andrade', 'administrador', 'enrique.qzada@gmail.com', 'e190d72eea11d9049870eaa2d41e410f', 'super usuario');
...
--
ALTER TABLE `adaptador_red`
  MODIFY `id_red` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `almacenamiento`
  MODIFY `id_almacenamiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `inventario_adm`
  MODIFY `id_adm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `movimiento`
  MODIFY `id_cambio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
