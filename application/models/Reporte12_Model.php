...
class Reporte12_Model extends CI_Model
{
	...
	#función para hacer la consulta por unidad, le mandamos como parametros:
	#	$identificador = adm.identificador para administrativo lab.identificador_lab para laboratorio
	#	$tabla = la tabla inventario_adm ó inventario_lab
	#	$alias = el alias (adm para administrativo, lab para laboratorio)
	#	$sistema = el campo para la descripcion del sistema (des_sistema_id para administrativo, descripcion_sistema_id para laboratorios)
