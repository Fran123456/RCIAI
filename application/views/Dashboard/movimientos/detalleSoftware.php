...
<body>
	...
	<?php if($detalle != false) {?>
		...
		<div class="content">
			<div class="row">
				<div class="col-md-12">
					<center>
						<h3>Detalle de movimiento de software</h3>
					</center>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						<label >Nombre del Técnico que reporta el cambio</label>
	...
	<a class="btn btn-success" href="<?php echo base_url('listado-software')?>">ATRAS</a>
