		...
		<tbody id="showdata">
			<?php for($i = 0 ; $i < count($info) ; $i++): ?>
				<tr>
					...
					<td><a href="<?php echo base_url();?>componentes/edit-componentes/<?php echo $info[$i]['pc_id'];?>" class="btn btn-success item-view"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
