	...
	<table id="tabla" class="table table-dark table-hover">
		...
		<tbody id="showdata">
			<?php for($i = 0 ; $i < count($info) ; $i++): ?>
				<tr>
					 <td> <?php echo $i+1 ?></td>
					<th><?php echo empty($info[$i]['pc_ids']) ? '<span style= "color:red">no disponible</span>' : $info[$i]['pc_ids'] ?></th>
					
					<td><a href="<?php echo base_url();?>sistema/edit-sistema/<?php echo $info[$i]['pc_ids'];?>" class="btn btn-success item-view"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
