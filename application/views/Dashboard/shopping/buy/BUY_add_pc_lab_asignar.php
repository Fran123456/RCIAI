...
<form method="post" action="<?php echo base_url()?>BUYLAB_Controller/pc_nuevo_add">
 <div>
...
<div class="col-md-12">
        ...
        <tbody>
          <tr>
            ...
            <td><input type="text" required="" name="des-0" id="des-nombre" value="" class="form-control int"></td>
