...
<form method="post" action="<?php echo base_url()?>AddBodega_Controller/periferico_nuevo_add">

  <div class="col-md-12">
    <div class="panel">
                      <div class="panel-heading">
                        <h3 class="panel-title">Periferico gdsfsd</h3>
                        <div class="right">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="date" required="" class="form-control" value="" name="fecha_ingreso-0">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
