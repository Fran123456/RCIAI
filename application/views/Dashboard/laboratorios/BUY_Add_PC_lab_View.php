	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        <a class="btn btn-secondary" href="<?php echo base_url()?>add-buy-lab" >Salir</a>
...
<?php if($this->session->flashdata('validar')): ?>
				...
				<div class="alert alert-success alert-dismissible " role="alert">
				  <h4><strong><?php echo $this->session->flashdata('validar') ?></strong> <h4>
				  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				    <span aria-hidden="true">&times;</span>
				  </button>
				</div>
     ...
     <form  method="post" action="<?php echo base_url()?>laboratorio-PC-add-buy" >
     			...
     			<h4>Codigo PC</h4>
			      ...
			      <div id="cod" class="row">
			      	...
			      	<div class="col-md-2">
			      	     <div class="form-group">
			      	     	<label></label>
					        <input type="text" readonly=""  name="res-cod" value="{{cod1}}-PC{{cod2}}"   class="form-control int">
					     </div>
			      	</div>
			      	<div class="col-md-6">
			      		<div class="form-group">
			      			<label>ID compra</label>
			      			<input type="text" name="id_compra" class="form-control" readonly="" value="<?php echo $compra[0]['id_compra'] ?>">
			      		</div>
...
<!-- PANEL DEFAULT -->
                      ...
                      <div class="panel-body">
                          <div class="row">
                                ...
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <label>Destino</label>
                                    <input type="text" readonly class="form-control" value="Informática" name="destinoPC-1">
                                    <input hidden type="text" value="25" name="destinoPC_Falso-1">
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <label>Laboratorio</label>
                                    <select class="form-control" name="destinoLAB-1">
                                    	<option value="lab-01" >LAB01</option>
                                    	<option value="lab-02" >LAB02</option>
                                    	<option value="lab-03" >LAB03</option>
                                    	<option value="lab-04" >LAB04</option>
                                    	<option value="lab-05" >LAB05</option>
                                    	<option value="lab-HW" >LAB HW</option>
                                    	<option value="lab-red" >LAB Redes</option>
                                    </select>
                                    <input hidden type="text" value="25" name="destinoID">
                                  </div>
                                </div>
                                <div class="col-md-3">
                                  <div class="form-group">
                                    <label>Fecha ingreso</label>
                                    <input type="date"  class="form-control" value="" name="ingreso-1">
                                  </div>
                                </div>
                                <div class="col-md-3">
                                  <div class="form-group">
                                    <label>Fecha de salida</label>
                                    <input type="date"  class="form-control"  name="salida-1">
                                  </div>
                                </div>
                           </div>
                        <br>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      <label>Nombre</label>
                                      <input type="text" id="nombre-{{item.id - 1}}-{{item3}}-{{index}}" required class="form-control"  name="nombre-{{item3}}-{{index}}">
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group">
                ...
                <div class="col-md-12"><input type="submit" value="Enviar" class="btn btn-success btn-lg" name=""> </div>
