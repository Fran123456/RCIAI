    ...
    <?php require 'application/views/Plantilla/panel.php'; ?>  <!-- AQUI REQUERIMOS DE EL ARCHIVO QUE NOS PROPORCIONA EL MENU DESPLEGABLE-->
     ...
     <form action="<?php echo base_url() ?>addbuy-labo" method="post" id="form-compra">
        ...
        <div class="alert alert-success alert-dismissible" role="alert">
          <strong><?php echo $this->session->flashdata('item') ?></strong> 
    	...
    	<div class="panel" > <!--INICIO DE COMPONENTE VUE-->
                ...
                <div class="panel-body">
					...
					<a href="<?php echo base_url().'add-PC-laboratorios-buy'?>" class="btn btn-success">Agregar elementos a la compra</a>
                    </div>
              </div>
     </form>
