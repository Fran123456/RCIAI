...
<body>
 ...
 <div class="row">
 	 <div class="col-md-6">
  	<h3> Mouses de audiovisuales </h3>
  </div>
  <div class="col-md-6 text-right">
  	<a href="<?php echo base_url() ?>Audiovisuales-mouses-agregar" class="btn btn-info">Nuevo mouse</a>
  </div>
 </div>
<br> <br>
		...
		<tbody id="showdata">
			<?php for ($i = 0 ; $i < count($data) ; $i++ ) { ?>
				<tr>
					...
					<td><a href="<?php base_url();?>Audiovisuales-mouses-edit/<?php echo $data[$i]['id'];?>" class="btn btn-warning item-view"><i class="fa fa-edit" aria-hidden="true"></i></a></td>

					<td><a href="<?php base_url();?>Audiovisuales-mouses-eliminar/<?php echo $data[$i]['id'];?>" class="btn btn-danger item-view"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
				</tr>
			<?php } ?>
