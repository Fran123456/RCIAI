		  	...
		  	<tbody id='showdata'>
		  		<?php foreach ($registro as $key){?>
					<tr>
						...
						<td><a href="<?php echo base_url('sotfware/'.$id=$key->identificador.'/'.$unidad=$this->uri->segment(2));?>" id="sw" class="btn btn-primary item-sw" data="<?php echo $key->identificador ?>"><i class="fa fa-tasks" aria-hidden="true"></i></a> </td>
