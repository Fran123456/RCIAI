...
<html>
<head>
	<title>Sustitución de periferico con codigo</title>
...
<h2>Sustitución para unidad</h2>

<form method="post" action="<?php echo base_url()?>Sustitucion_Controller/sustituir_periferico_form_code_unidad">
            ...
            $('#bt').remove();
	  		var dato = $('#cod').val();
		  	 ...
		  	 $.ajax({
			     type: 'ajax',
			     method: 'post',
			     url: '<?php echo base_url() ?>Sustitucion_Controller/get_perifericos_inventario',
			     data: {dato: dato},
			     async: false,
			     dataType: 'json',
