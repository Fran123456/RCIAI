...
<html>
<head>
	<title>Sustitución de cpu para lab</title>
...
<h2>Sustitución para laboratorios de CPU</h2>

<form method="post" action="<?php echo base_url()?>Sustitucion_Controller/sustituir_cpu_sad_labo">
            ...
            $('#bt').remove();
	  		var dato = $('#cod').val();
		  	 ...
		  	 $.ajax({
			     type: 'ajax',
			     method: 'post',
			     url: '<?php echo base_url() ?>Sustitucion_Controller/get_pcLAB',
			     data: {dato: dato},
			     async: false,
			     dataType: 'json',
