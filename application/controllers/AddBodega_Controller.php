...
class AddBodega_Controller extends CI_Controller {
 ...
 #obtiene unidad
  ...
  public function get_pc_labxlab(){
   ...
   {
    $compra = $compraA;
		$this->load->view('Dashboard/bodega/buy/BUY_validate_View', compact('compra', 'cantidad'));
   }
 ...
 #valida la compra
   public function validate_buy()
   {
            ...
            $this->load->view('Dashboard/bodega/buy/BUY_add_element_View', compact('datos'));
...
public function otro_asignado_add_new(){
 ...
 public function periferico_nuevo_add(){
     ...
     $this->session->set_flashdata('buyxx', 'Elemento agregado a la compra correctamente');
     redirect(base_url().'bodega_Controller/detalle/'.$this->input->post('serial-0'));
   }
